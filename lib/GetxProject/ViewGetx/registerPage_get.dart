...
class SignUpPageGet extends StatefulWidget {
  const SignUpPageGet({Key? key}) : super(key: key);

  @override
  State<SignUpPageGet> createState() => _SignUpPageGetState();
}

class _SignUpPageGetState extends State<SignUpPageGet> {
